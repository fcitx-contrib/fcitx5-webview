...
export const auxUp = document.querySelector('.fcitx-aux-up')!
export const auxDown = document.querySelector('.fcitx-aux-down')!
export const contextmenu = document.querySelector('.fcitx-contextmenu')! as HTMLElement
